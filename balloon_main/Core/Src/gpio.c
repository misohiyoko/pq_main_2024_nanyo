...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPS_RESET_Pin|GPS_SAFE_Pin|RM92A_RESEST_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = GPS_RESET_Pin|GPS_SAFE_Pin|RM92A_RESEST_Pin;
  ...
  GPIO_InitStruct.Pin = GPIO_PPS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIO_PPS_GPIO_Port, &GPIO_InitStruct);
